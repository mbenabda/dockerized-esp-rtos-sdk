...
ARG XTENSA_LX106_RELEASE=xtensa-lx106-elf-linux64-1.22.0-100-ge567ec7-5.2.0
ARG XTENSA_ESP32_RELEASE=xtensa-esp32-elf-linux64-1.22.0-80-g6c4433a-5.2.0
...
ADD https://dl.espressif.com/dl/${XTENSA_ESP32_RELEASE}.tar.gz /xtensa-esp32.tar.gz
